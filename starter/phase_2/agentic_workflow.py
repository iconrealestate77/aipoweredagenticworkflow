...
routes = [
    ...
    },
    {
        ...
        "description": "Responsible for defining product features by grouping related user stories. Does not define individual user stories or engineering tasks.",
        "func": lambda x: program_manager_support_function(x),
    },
    {
        "name": "Development Engineer",
        "description": "Responsible for defining the development tasks and engineering work required to implement product features and user stories.",
...
for i, step in enumerate(workflow_steps):
    print(f"\n--- Executing step {i + 1}/{len(workflow_steps)} ---")
    print(f"Step: {step}")
